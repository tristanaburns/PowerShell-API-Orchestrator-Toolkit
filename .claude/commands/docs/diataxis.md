...
**FOR ALL DIATAXIS DOCUMENTATION CREATION, YOU MUST:**
- **MUST:** Create enduring documentation following Diataxis framework (Tutorial, How-to, Reference, Explanation)
...
- **MUST:** Apply Diataxis principles to enduring HOW-TO-USE documentation only
...
Create documentation following Ditaxis framework for: $argument
...
## Content
[Main documentation content following type-specific structure]
...
Generate documentation following Ditaxis principles.