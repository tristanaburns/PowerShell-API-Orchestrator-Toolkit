...
Refactor the following code/component: $argument
...
- Rename for clarity and purpose
...
3. **Incremental Changes**
   - Small, atomic refactoring steps
...
Execute refactoring with zero regression tolerance.