...
Create a new $1 component called $2 with $3 functionality

## Component Generation Protocol

### Component Structure
Based on the component type ($1), generate appropriate structure:
...
interface $2Props {
  // Define props based on $3
}

export const $2: React.FC<$2Props> = (props) => {
  // Implement $3 functionality
  return (
...
// $2.test.tsx
// $2.module.css
// $2.stories.tsx (if using Storybook)
```
...
2. **Test File**: unit tests
3. **Style File**: Scoped styles
4. **Type Definitions**: Props/Input interfaces
