...
$functionsToAnalyze = @(
    ...
    'Get-SyncManagerCredential', 
    'Add-StandardCredentialParam',
    'Get-ConsolidatedResourceType',
    'Merge-ConfigurationObject',
    'Get-ExportResourceType',
    'Get-ImportResourceType',
